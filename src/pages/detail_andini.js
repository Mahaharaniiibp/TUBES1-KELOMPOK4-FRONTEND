    ...
    <div id="carouselFoto" className="carousel slide" data-bs-ride="carousel" data-interval={4000}>
      ...
      <div className="carousel-inner">
        <div className="carousel-item active">
          <img src="/assets/andini_slide1.png" className="d-block w-100" alt="..." />
        </div>
        <div className="carousel-item">
          <img src="/assets/Bacground Home.png" className="d-block w-100" alt="..." />
        </div>
        <div className="carousel-item">
          <img src="/assets/andini_volly.png" className="d-block w-100" alt="..." />
        </div>
      </div>
    ...
    <div className="flex-container space-between">
      <div className="col card">
        <div>
          ...
          <p><i className="fa-solid fa-user" />Perkenalkan nama saya Masyita Andini Larasati biasa dipanggil andini. Saya lahir di Makassar 21 September 2005. Sekarang saya sedang menempuh pendidikan di SMK Telkom Malang di jurusan RPL. Saya memiliki hobi yaitu olahraga, banyak cabang olahraga yang saya gemari tetapi sekarang saya sedang menekuni olahraga voli dan posisi saya di tim sebagai libero. Saya menyukai warna darktone seperti hitam dan abu abu. </p>
        </div>
      </div>
    </div>
  </section>
  {/* End of Detail Biodata */}
  {/*Maps */}
  <section id="sec_maps">
    <div className="flex-container space-between">
      <div className="col card">
        <div className="maps-placeholder">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3951.228184604573!2d112.63930001477942!3d-7.975352594256041!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd62839b226f645%3A0xacbe705efb0cf392!2sLapangan%20Rampal%20Yonif%20Mekanis%20512%20Marabunta!5e0!3m2!1sid!2sid!4v1670956751178!5m2!1sid!2sid" width={600} height={450} style={{border: 0}} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
        </div>
        <div>
          <h3>Lapangan Rampal Yonif Mekanis 512 Marabunta</h3>
          <p><i className="fa-solid fa-user" />Banyuwangi dikenal dengan keindahan lautnya. Menikmati santapan sambil memandang view laut terasa sangat menyenangkan. Salah satu tempat makan yang menyuguhkan keindahan laut langsung yang dipadukan dengan spot foto instagramable yakni Three B Café Banyuwangi.Pemandangan dari Three B Café, bisa melihat langsung indahnya Pulau Menjangan di Taman Nasional Bali Barat dengan gunung yang gagah menjulang. Tempat terbaik untuk makan di café ini adalah pada bagian rooftop karena kita bisa melihat pemandangan tersebut dengan sangat jelas. Untuk lokasi Three B Resto berada di Jl. Raya Situbondo, Lingkar Krajan, Bulusa, Kalipuro, Kabupaten Banyuwangi. Lokasinya cukup dekat dengan pelabuhan Ketapang dan Stasiun Banyuwangi Ketapang.</p>
        </div>
      </div>
    </div>
  </section>

      ...
      <div id="carouselFoto" className="carousel slide" data-bs-ride="carousel" data-interval={4000}>
        ...
        <div className="carousel-inner">
          ...
          <div className="carousel-item">
            <img src="Asset/Bacground Home.png" className="d-block w-100" alt="..." />
          </div>
          <div className="carousel-item">
            <img src="Asset/andini_voli.png" className="d-block w-100" alt="..." />
          </div>
        </div>
        ...
        <div className="flex-container space-between">
          <div className="col card">
            <div>
              ...
              <p><i className="fa-solid fa-location-dot" />Perkenalkan nama saya Masyita Andini Larasati biasa dipanggil andini. Saya lahir di Makassar 21 September 2005. Sekarang saya sedang menempuh pendidikan di SMK Telkom Malang di jurusan RPL. Saya memiliki hobi yaitu olahraga, banyak cabang olahraga yang saya gemari tetapi sekarang saya sedang menekuni olahraga voli dan posisi saya di tim sebagai libero. Saya menyukai warna dark tone seperti hitam dan abu abu.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="flex-container space-between">
          <div className="col card">
            <div className="maps-placeholder">
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2239.200645756214!2d112.63974094884877!3d-7.973671413980336!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd62839b226f645%3A0xacbe705efb0cf392!2sLapangan%20Rampal%20Yonif%20Mekanis%20512%20Marabunta!5e1!3m2!1sid!2sid!4v1667138584113!5m2!1sid!2sid" width={600} height={450} style={{ border: 0 }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
            </div>
            <div>
              <h3>Lapangan Rampal Yonif Mekanis 512 Marabunta</h3>
              <p><i className="fa-solid fa-user" />Lapangan Rampal merupakan salah satu sarana ruang terbuka hijau yang ada di Kota Malang. Lapangan ini menempati lahan milik Kodam V/Brawijaya yang biasa dijadikan oleh masyarakat Malang sebagai tempat untuk berolahraga. Tak hanya di pagi hari, sore hari pun ada saja orang yang sengaja membakar keringat di lapangan ini. Lahan di Lapangan Rampal ini terbilang sangat luas dan terbagi menjadi beberapa bagian. Di sini ada beberapa fasilitas olahraga yang cukup lengkap. Ada jogging track yang mengelilingi lapangan ini pada bagian tengahnya. Ada pula dua lapangan basket, dua lapangan voli, dan dua lapangan tenis. </p>
            </div>
          </div>
        </div>
      </section>

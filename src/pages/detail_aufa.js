    ...
    <div className="flex-container space-between">
      <div className="col card">
        <div>
          ...
          <p><i className="fa-solid fa-user" />Perkenalkan nama saya Moh. Aufa Azka Fabian biasa di panggil aufa. Saya lahir di Banyuwangi pada tanggal 5 Mei 2005. Sekarang saya sedang menempuh pendidikan di SMK Telkom Malang di jurusan RPL. Saya memiliki hobi yaitu berenang, terutama yang kolamnya dingin hehe. Saya suka berenang karena berenang merupakan salah satu olahraga yang tidak mengeluarkan keringat dan membuat badan segar </p>
        </div>
      </div>
    </div>
  </section>

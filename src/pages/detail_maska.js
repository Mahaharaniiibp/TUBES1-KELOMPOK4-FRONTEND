      ...
      <div className="flex-container space-between">
        <div className="col card">
          <div>
            ...
            <p><i className="fa-solid fa-location-dot" />Perkenalkan nama saya Maskharor Amnan Nidhom biasa di panggil maskha. Saya lahir di Jakarta pada tanggal 16 Desember 2005. Sekarang saya sedang menempuh pendidikan di SMK Telkom Malang di jurusan RPL. Saya memiliki hobi yaitu olahraga, khususnya di olahraga basket. Hewan kesukaan saya adalah kucing. Saya menyukai warna biru, karena menurut saya warna biru melambangkan ketenangan. Kelebihan saya adalah tinggi saya. tinggi saya 175 cm. Lalu untuk kekurangan saya, saya terlalu tinggi </p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div className="flex-container space-between">
        <div className="col card">
          <div className="maps-placeholder">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3322.662637572759!2d112.60139503206781!3d-7.964379511603697!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e788289b745f173%3A0xfb1033c3b775b284!2sChampions%20Futsal%20Puncak%20Mandala!5e0!3m2!1sid!2sid!4v1667264288219!5m2!1sid!2sid" width={600} height={450} style={{border: 0}} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
          </div>
          <div>
            <h3>Lapangan Champion</h3>
            <p><i className="fa-solid fa-user" />Lapangan Champion merupakan tempat penyewaan lapangan basket dan futsal. Lapangan ini berlokasi di daerah Tidar Malang. Lapangan champion memiliki fasilitas yang cukup untuk tempat penyewaan lapangan. Mulai dari tempat tunggu/bangku penonton yang cukup luas, kantin yang cukup lengkap, serta lapangan yang bersih dan lengkap. Lapangan ini biasa digunakan untuk latihan ataupun dijadikan tempat funmatch/sparing. Jika kita menyewa lapangan selama 1 jam akan diberikan gratis 4 botol air mineral 600 ml. </p>
          </div>
        </div>
      </div>
    </section>

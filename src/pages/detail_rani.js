...
import '../assets/css/style_detail.css'
const Detail_rani = () => {
  return (
    <div className='allDetail'>
      <div>
        ...
        {/* end of navbar */}
        {/* Carousell  */}
        <div id="carouselFoto" className="carousel slide" data-bs-ride="carousel" data-interval={4000}>
          <div className="carousel-indicators">
            <button type="button" data-bs-target="#carouselFoto" data-bs-slide-to={0} className="active" aria-current="true" aria-label="Slide 1" />
            <button type="button" data-bs-target="#carouselFoto" data-bs-slide-to={1} aria-label="Slide 2" />
            <button type="button" data-bs-target="#carouselFoto" data-bs-slide-to={2} aria-label="Slide 3" />
          </div>
          ...
          <button className="carousel-control-next" type="button" data-bs-target="#carouselFoto" data-bs-slide="next">
        ...
        {/* End of Carousell  */}
        {/*Biodata */}
        <section id="sec_biodata">
          <div className="flex-container space-between">
            <div className="col card">
              <div>
                <h3>Maharani B'anica Putri</h3>
                <p><i className="fa-solid fa-location-dot" />Perkenalkan nama saya Maharani B'anica Putri. Saya biasa di panggil Rani. Saya lahir di Tulungagung pada tanggal 01 Juni 2005. Sekarang saya sedang menempuh pendidikan di SMK Telkom Malang jurusan Rekayasa Perangkat Lunak (RPL) kelas XI. Saya memiliki hobi yaitu menonton film, khususnya di hari weekend. Meskipun hobi saya adalah menonton film tapi saya bisa mengimbangi dengan waktu belajar saya. Film yang sering saya tonton adalah film yang bergenre fantasy, sehingga film terbaik saya adalah Harry Potter. Hewan kesukaan saya adalah kelinci, saya mempunyai kelinci di rumah yang bernama Piko. Saya menyukai warna pink atau merah muda, karena menurut saya warna pink atau merah muda membawa keceriaan.</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="flex-container space-between">
            <div className="col card">
              <div className="maps-placeholder">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15799.427422378063!2d114.38909212617594!3d-8.116053906516614!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd146eca9a3f2ff%3A0xcdf6c76c8c4cbf57!2sThree%20b%20Villa%20and%20Resto!5e0!3m2!1sen!2sid!4v1667133685886!5m2!1sen!2sid" width={600} height={450} style={{ border: 0 }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
              </div>
              <div>
                <h3>Kusuma Pinus Batu</h3>
                <p><i className="fa-solid fa-user" />Kusuma pinus batu merupakan komplek villa favorit yang berlokasi di jalan abdul gani atas kota batu, villa pinus merupakan salah satu komplek yang di miliki oleh developer terbaik di kota batu yaitu PT. Kusumantara Graha Jayatrisna yang bergerak di bidang perhotelan dan Real Estate, terletak di tengah kota batu yang sejuk dan dingin tepatnya di atas ketinggian 1000 meter diatas permukaan laut, kawasan kusuma pinus di kelilingi oleh beberapa tempat wisata terkenal di kota batu, yaitu, jatimpark, Museum Angkut, BNS dah beberapa wisata lain di kota batu, Sewa Villa Pinus Batu relatif murah jika melihat fasilitas dan type bangunan villa yang di tawarkan, di kawasan ini anda bisa memilih berbagai jenis villa di batu, mulai dari villa 2 kamar tidur hingga villa 9 kamar tidur yang mampu menampung hingga 40 orang yang di lengkapi fasilitas kolam renang dan berbagai fasilitas pendukung lainnya.</p>
              </div>
            </div>
          </div>
        </section>
